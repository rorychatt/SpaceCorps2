// Shopping/Shop
// Div constants
const shoppingShipsDiv = document.getElementById("shopping_ships") as HTMLElement;
const shoppingWeaponsDiv = document.getElementById("shopping_weapons") as HTMLElement;
const shoppingAmmoDiv = document.getElementById("shopping_ammunition") as HTMLElement;
const shoppingGeneratorDiv = document.getElementById("shopping_generators") as HTMLElement;
const shoppingExtrasDiv = document.getElementById("shopping_extras") as HTMLElement;
const shoppingDesignDiv = document.getElementById("shopping_design") as HTMLElement;
const shoppingDonateDiv = document.getElementById("shopping_donate") as HTMLElement;

// Button constants
const shoppingShipsButton = document.getElementById("shop_ships") as HTMLElement;
const shoppingWeaponsButton = document.getElementById("shop_weapons") as HTMLElement;
const shoppingAmmoButton = document.getElementById("shop_ammo") as HTMLElement;
const shoppingGeneratorButton = document.getElementById("shop_generators") as HTMLElement;
const shoppingExtrasButton = document.getElementById("shop_extras") as HTMLElement;
const shoppingDesignButton = document.getElementById("shop_design") as HTMLElement;
const shoppingDonateButton = document.getElementById("shop_donate") as HTMLElement;
...
const aucMonthlyButton = document.getElementById("auc_month_btn") as HTMLElement;
...
// Clan Buttons
const clanInformationBtn = document.getElementById("clan_info_button") as HTMLElement;
const clanMembersBtn = document.getElementById("clan_members_btn") as HTMLElement;
const clanPoliticsBtn = document.getElementById("clan_politics_btn") as HTMLElement;
const clanEconomicsBtn = document.getElementById("clan_economics_btn") as HTMLElement;
...
const clanEconomicsDiv = document.getElementById("clan_economics") as HTMLElement;
...
// Player Buttons
const playerPilotBtn = document.getElementById("profile_pilot_button") as HTMLElement;
const playerRankingBtn = document.getElementById("profile_ranking_button") as HTMLElement;
const playerHangarBtn = document.getElementById("profile_hangar_button") as HTMLElement;
const playerWorkroomBtn = document.getElementById("profile_workroom_button") as HTMLElement;

// Player DIV
const playerPilotDiv = document.getElementById("profile_pilot") as HTMLElement;
const playerRankingDiv = document.getElementById("profile_ranking") as HTMLElement;
const playerHangarDiv = document.getElementById("profile_hangar") as HTMLElement;
const playerWorkroomDiv = document.getElementById("profile_workroom") as HTMLElement;
...
const profileCloseBtn = document.getElementById("profile_close_btn") as HTMLElement;
